...
type FilteredType<Type, Key extends keyof Type> = Type & {[key in Key]-?: Exclude<Type[key], undefined>};
...
function filterUndefined<Type, Key extends keyof Type>(key: Key): (object: Type) => object is FilteredType<Type, Key> {
